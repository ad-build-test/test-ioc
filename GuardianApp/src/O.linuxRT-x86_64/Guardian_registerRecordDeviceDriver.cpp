...
/* Generated from ../O.Common/Guardian.dbd */
...
epicsShareExtern reg_func pvar_func_GuardianDriverRegister,
...
int Guardian_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/afs/slac.stanford.edu/u/cd/pnispero/test-ioc";
    ...
    pvar_func_GuardianDriverRegister();
...
/* Guardian_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"Guardian_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(Guardian_registerRecordDeviceDriver(*iocshPpdbbase));
}
